...
/**
 * Whether or not to automatically fetch the room from the server.
 *
 * The default value is YES.
 **/
@property (assign) BOOL autoFetchRoom;
...
- (void)xmppRoom:(XMPPRoom *)sender didFetchRoomList:(NSArray *)items;
- (void)xmppRoom:(XMPPRoom *)sender didNotFetchRoomList:(XMPPIQ *)iqError;
