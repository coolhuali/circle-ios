...
@dynamic messageID;
@dynamic messageDelivered,serverDelivered;
@dynamic nickname;
...
- (BOOL)isServerDelivered
{
    return [self.serverDelivered boolValue];
}

- (void)setIsServerDelivered:(BOOL)flag
{
    self.serverDelivered = [NSNumber numberWithBool:flag];
}

- (BOOL)isMessageDelivered
{
    return [self.messageDelivered boolValue];
}

- (void)setIsMessageDelivered:(BOOL)flag
{
    self.messageDelivered = [NSNumber numberWithBool:flag];
}
#pragma mark Hooks
