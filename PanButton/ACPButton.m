...
#define kLabelFont [UIFont fontWithName:@"Verdana-Bold" size:15]
...
//         }
//     }
//     NSLog(@"viewController  self:%f,%f",self.center.x,self.center.y);
//    CGPoint oricenter=self.center;
//     UIView* next=[self superview];
//     UIResponder *nextResponder=[next nextResponder];
//     if ([nextResponder isKindOfClass:[UIViewController class]]) {
//             self.center=oricenter;
//         NSLog(@"if!");
//         
//         return (UIViewController *)nextResponder;
//     }
