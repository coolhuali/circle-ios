...
#import "POVProgressIndicator.h"

@implementation POVProgressIndicator
{
...
-(void)initProgressView
{
    ...
    _progressView.frame = CGRectMake(0, 0, self.frame.size.width, 12.0);
...
-(void)setProgress:(float)progress
{
    ...
    if (progress != 1.0 && _totalSize!=-1.0)
    {
        ...
        if (_totalSize>1024*1024) {
            _label.text=[NSString stringWithFormat:@"%.2f/%.2f MB",_totalSize*progress/1024/1024,_totalSize/1024/1024];
        }else
        {
