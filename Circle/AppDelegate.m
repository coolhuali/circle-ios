...
- (void) showMainREFrostedView
{
    DEMONavigationController *navigationController = [[DEMONavigationController alloc] initWithRootViewController:[[ProfilePhotoViewController alloc] init]];
...
- (void) showMain
{
    BUPOViewController *mainViewController= [[BUPOViewController alloc] initWithNibName:@"BUPOViewController" bundle:nil];
