...
@implementation MessageRecentCell
...
-(void)setUnionObject:(NSDictionary*)aUnionObj
{
    ...
    [_messageConent setText:[aUnionObj objectForKey:@"body"]];
    ...
    [_userHead setImageWithURL:[MBaseModel getAvatarUrlCache:(NSString *)[aUnionObj objectForKey:@"user"]]];
