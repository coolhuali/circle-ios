...
@interface ImageSourceViewController ()
...
- (void)viewDidLoad
{
    ...
    self.navigationItem.rightBarButtonItem =[[UIBarButtonItem alloc]initWithBarButtonSystemItem:UIBarButtonSystemItemCompose target:self action:@selector(moreAction)];
    self.title = [NSString stringWithFormat:@"%d/%d",(_currentIndex+1),[_bimageUrlArr count]];
}
