...
- (void)refreshChatView
{
    ...
    messagesFetchResultsController = [[OFCXMPPManager sharedManager] messagesFetcher:[chatToBuddyJID bare]];
...
- (void)sendMessage
{
    if([inputView.text length] > 0){
        ...
        [[OFCXMPPManager sharedManager] sendMessage:chatToBuddyJID withMessage:messageStr];
    }
    inputView.text = nil;
